...
// docker run -it -p 8080:8081 my-app    //container run until the session is running in bash
// docker run -d -p 8080:8081 my-app     //container run in background independently until we want
